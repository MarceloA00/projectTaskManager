...
<?php require 'includes/templates/barra.php' ?>
...
<div class="contenedor">
    <?php require 'includes/templates/sidebar.php'; ?>
        ...
        if ($proyecto) { ?>
            ...
            <form action="#" class="agregar-tarea">
                <div class="campo">
                    ...
                    <input type="text" placeholder="Nombre Tarea" class="nombre-tarea" maxlength="100">
                </div>
                ...
                if ($tareas->num_rows > 0) {
                    foreach ($tareas as $tarea) { ?>
                        <li id="tarea:<?php echo $tarea['id'] ?>" class="tarea">
                            <p class="wrap-p"><?php echo $tarea['nombre'] ?></p>
                            <div class="acciones">
